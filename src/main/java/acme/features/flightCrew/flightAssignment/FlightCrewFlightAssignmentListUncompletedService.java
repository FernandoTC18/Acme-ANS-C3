...
@GuiService
public class FlightCrewFlightAssignmentListUncompletedService extends AbstractGuiService<FlightCrew, FlightAssignment> {
	...
	public void load() {
		...
		flightAssignment = this.repository.getUncompletedAssignmentsByMemberId(memberId, MomentHelper.getCurrentMoment());
