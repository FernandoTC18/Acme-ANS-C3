...
<acme:form>
	...
	<acme:input-select code="manager.leg.form.label.plane" path="plane" choices="${planes}"/>
	<acme:input-select code="manager.leg.form.label.status" path="status" choices="${statusOptions}"/>
