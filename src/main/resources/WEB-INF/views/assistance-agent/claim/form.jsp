...
<acme:form>
	...
	<acme:input-textbox code="assistance-agent.claim.form.label.draftMode" path="draftMode"/>
	
	<jstl:if test="${!readonly}">
		<jstl:choose>
			<jstl:when test="${_command == 'show' && draftMode == false}">
				<acme:button code="assistance-agent.claim.form.button.tracking-log.list" action="/assistance-agent/tracking-log/list?id=${id}"/>
			</jstl:when>
